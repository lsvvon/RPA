...
while loopFlag:
    ...
    try:
        ...
        # else:            
        #     print("이미 드라이버가 실행 중입니다. URL 로딩을 건너뜁니다.")

        # driver가 여전히 None이면 여기서 작업을 종료할 수도 있습니다
        # 예를 들어, driver.quit()으로 종료할 수도 있습니다.

        # driver = common_module.initialize_driver()
        #url = "https://bizssl.shinhanci.co.kr/SHSCHER/Asp/RPA/CA_RPA_Condition.asp"
        # url = "https://bizssl.shinhanci.co.kr/SHSCHER/Asp/RPA/CA_RPA3.htm"
        ...
        for entry in data:
            ...
            # 우선순위 정상처리되면 종료한다.
            if KBland_ResCode != '' and Rtech_ResCode != '' and (KBland_ResCode == '00000000' or Rtech_ResCode == '00000000'):
                break
