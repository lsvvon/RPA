...
data_dir = Path(r"C:\python\RPA\rpa\captcha_images_v5")
...
prediction_model.save('./model5000.keras')

# SavedModel이 포함하는 것
# model.save('my_model')을 호출하면 다음을 포함하는 my_model 폴더를 생성합니다.
# assets  fingerprint.pb  keras_metadata.pb  saved_model.pb  variables
# 모델 아키텍처 및 훈련 구성(옵티마이저, 손실, 메트릭 등)은 saved_model.pb에 저장됩니다. 가중치는 variables/ 디렉터리에 저장됩니다.모델 아키텍처 및 훈련 구성(옵티마이저, 손실, 메트릭 등)은 saved_model.pb에 저장됩니다. 가중치는 variables/ 디렉터리에 저장됩니다.
